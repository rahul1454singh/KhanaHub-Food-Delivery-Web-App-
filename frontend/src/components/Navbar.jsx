        ...
        <div className="container navbar-container">
          <div className="navbar-left">
            ...
            <a href="/" className="navbar-brand" onClick={(e) => { e.preventDefault(); handleNavigate('home'); }}>
              <img src="https://res.cloudinary.com/n3wagpa9/image/upload/f_auto,q_auto/v1788190253/newlogo_sterro.png" alt="KhanaHub Logo" className="navbar-logo" />
      ...
      <div className={`mobile-left-drawer ${isMobileMenuOpen ? 'open' : ''}`}>
        <div className="mobile-drawer-header">
          <div className="mobile-drawer-brand" onClick={() => handleNavigate('home')}>
            <img src="https://res.cloudinary.com/n3wagpa9/image/upload/f_auto,q_auto/v1788190253/newlogo_sterro.png" alt="KhanaHub Logo" className="mobile-drawer-logo" />
